...
namespace BlueBell
{
	...
	void Matrix::RotateX(float angle, CombineFunc combine)
	{
	...
	void Matrix::RotateY(float angle, CombineFunc combine)
	{
	...
	void Matrix::RotateZ(float angle, CombineFunc combine)
	{
	...
	void Matrix::Rotate(Vector3D rotation, CombineFunc combine)
	{
		Matrix rotationMatrixX = Matrix::identity;
		Matrix rotationMatrixY = Matrix::identity;
		Matrix rotationMatrixZ = Matrix::identity;
	...
	void Matrix::Translate(Vector3D translation, CombineFunc combine)
	{
	...
	void Matrix::Scale(Vector3D scale, CombineFunc combine)
	{
	...
	void Matrix::ScaleRotateTranslate(Vector3D scale, Vector3D rotate, Vector3D translate, CombineFunc combine)
	{
		Matrix scaleMatrix = Matrix::identity;
		Matrix rotationMatrixX = Matrix::identity;
		Matrix rotationMatrixY = Matrix::identity;
	...
	void Matrix::ScaleRotate(Vector3D scale, Vector3D rotate, CombineFunc combine)
	{
		Matrix scaleMatrix = Matrix::identity;
		Matrix rotationMatrixX = Matrix::identity;
		Matrix rotationMatrixY = Matrix::identity;
	...
	void Matrix::ScaleTranslate(Vector3D scale, Vector3D translate, CombineFunc combine)
	{
		Matrix scaleMatrix = Matrix::identity;
		Matrix translateMatrix = Matrix::identity;
	...
	void Matrix::RotateTranslate(Vector3D rotate, Vector3D translate, CombineFunc combine)
	{
		Matrix rotationMatrixX = Matrix::identity;
		Matrix rotationMatrixY = Matrix::identity;
		Matrix rotationMatrixZ = Matrix::identity;
	...
	Matrix& Matrix::Transpose(bool createNew)
	{
	...
	void Matrix::ApplyPerspectiveMatrix(float aspect, float fov, float nearPlane, float farPlane)
	{
	...
	void Matrix::ApplyOrthoMatrix(float width, float height, float nearPlane, float farPlane)
	{
		float r = width;
		float l = 0.0f;
		float b = 0.0f;
	...
	void Matrix::ApplyOrthoMatrixOffCenter(float l, float r, float b, float t, float nearPlane, float farPlane)
	{
		*this = Matrix::identity;
	...
	void Matrix::ApplyViewMatrix(Vector3D cameraPos, Vector3D cameraLookAt)
	{
